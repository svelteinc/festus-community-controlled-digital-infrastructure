...
- **If you are a resident or civic volunteer:** start with `community_engagement/faq_v1.md`, `community_engagement/festus_facebook_explainer_v1.md`, `community_engagement/festus_dc_options_onepager_v1.md`, and, for regional context, `vision/festus_desoto_corridor_strategy_v1.md`.
