...
- **If you are in Festus (Mayor, Council, City Manager, EDC):** start with `vision/festus_city_manager_implementation_roadmap_v1.md`, then read `vision/project_vision_v1.md` and `vision/festus_council_briefing_v1.md` to align on goals. Next, review `governance/FDIA_FCIC_governance_v1.md` and `capital_stack/phase1_capital_stack_v1.md` before sharing the FAQ and Facebook explainer from `community_engagement/`. If you want to see how this can evolve into a city-wide Civic Authority & Assembly, also read `governance/festus_citywide_civic_authority_and_assembly_v1.md`.
...
- **If you are a resident or civic volunteer:** start with `community_engagement/faq_v1.md`, `community_engagement/festus_facebook_explainer_v1.md`, `community_engagement/festus_dc_options_onepager_v1.md`, and, for regional context, `vision/festus_desoto_corridor_strategy_v1.md` and `community_engagement/festus_desoto_corridor_growth_with_guardrails_onepager_v1.md`.
